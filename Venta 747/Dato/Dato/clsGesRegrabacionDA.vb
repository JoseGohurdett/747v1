...
Public Class clsGesRegrabacionDA
    ...
    Public Sub GuardaClienteGesPreVenta(ByVal _gestion As eGestion)
        Dim cmd As New SqlCommand
        Dim sql As String
        Dim dt As New DataTable
        ...
        sql = "Gestion.pa_ActualizaPreVenta"

        cmd.Parameters.AddWithValue("@idCliente", _gestion.C_ID)
        cmd.Parameters.AddWithValue("@banco", _gestion.G_BANCO)
        cmd.Parameters.AddWithValue("@tarjeta", _gestion.G_TIPO_TARJETA)
        cmd.CommandText = sql
        valido = con.Ejecutar(cmd, 2)
