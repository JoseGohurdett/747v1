Public Class eBeneficiario
    ...
    Private _B_NombreBeneficiario As String

    Public Sub New(b_ID As Integer, c_ID As Integer, b_Nro As String, b_Rut As String, b_Dv As String, b_Nombre As String, b_Paterno As String, b_Materno As String, b_TipoBeneficiario As Integer, b_FechaNacimiento As String, b_Porcentaje As String, b_Sexo As String, b_nombreBeneficiario As String)
        ...
        _B_Sexo = b_Sexo
        _B_NombreBeneficiario = b_nombreBeneficiario
    End Sub
    ...
    Public Property B_NombreBeneficiario As String
        Get
            Return _B_NombreBeneficiario
        End Get
        Set(value As String)
            _B_NombreBeneficiario = value
        End Set
    End Property
End Class
